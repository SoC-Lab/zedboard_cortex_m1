...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net btn_d_1 [get_bd_ports btn_d] [get_bd_pins util_vector_logic_7/Op2]
  connect_bd_net -net btn_l_1 [get_bd_ports btn_l] [get_bd_pins util_vector_logic_6/Op1]
  connect_bd_net -net btn_r_1 [get_bd_ports btn_r] [get_bd_pins util_vector_logic_5/Op2]
  ...
  connect_bd_net -net top_0_REC_BLK [get_bd_pins top_0/REC_BLK] [get_bd_pins util_vector_logic_5/Op1]
  connect_bd_net -net top_0_REC_ECU1 [get_bd_pins top_0/REC_ECU] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_2/In0]
  connect_bd_net -net top_0_REC_MCU [get_bd_pins top_0/REC_MCU] [get_bd_pins util_vector_logic_6/Op2] [get_bd_pins xlconcat_2/In2]
  connect_bd_net -net top_0_REC_THS [get_bd_pins top_0/REC_THS] [get_bd_pins util_vector_logic_7/Op1] [get_bd_pins xlconcat_2/In1]
  ...
  connect_bd_net -net util_vector_logic_6_Res [get_bd_pins util_vector_logic_6/Res] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net util_vector_logic_7_Res [get_bd_pins util_vector_logic_7/Res] [get_bd_pins xlconcat_0/In1]

...
# Input files
set mmi_file            "./Bitstreams/ecu.mmi"
set elf_file            "./Hexfiles/bram_a7.elf"
set source_bit_file     "./Bitstreams/cortex_i_cortex_ecu_partial.bit"
set reference_bit_file  "./m1_for_arty_a7_reference.bit"

# Output files
set output_bit_file "./Bitstreams/ecu.bit"
set output_mcs_file "./Bitstreams/ecu.mcs"

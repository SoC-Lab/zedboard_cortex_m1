...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.GUI_RM_NEW_NAME {cortex_engine} \
   CONFIG.GUI_RM_RESET_DURATION {32} \
   CONFIG.GUI_RM_RESET_REQUIRED {low} \
   CONFIG.GUI_SELECT_RM {2} \
  ...
  connect_bd_net -net prc_0_vsm_vs_cortex_rm_reset [get_bd_pins ila_0/probe0] [get_bd_pins prc_0/vsm_vs_cortex_rm_reset] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_ports int_RESET_INTERCONNECT] [get_bd_pins ila_0/probe2] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_ports int_RESET_PERIPHERAL] [get_bd_pins ila_0/probe3] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net -net top_0_MCU_GPIO_EXT [get_bd_ports ENGINE] [get_bd_pins xlconcat_2/In6]
  ...
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins ila_0/probe4] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net util_vector_logic_2_Res [get_bd_pins util_vector_logic_2/Res] [get_bd_pins xlconcat_2/In4]
  connect_bd_net -net util_vector_logic_3_Res [get_bd_pins ila_0/probe1] [get_bd_pins util_vector_logic_1/Op2] [get_bd_pins util_vector_logic_3/Res]

...
# module references:
# invert_singleValue, invert_singleValue, invert_singleValue, invert_singleValue, top
...
proc create_root_design { parentCell } {
  ...
  # Create instance: invert_singleValue_3, and set properties
  set block_name invert_singleValue
  set block_cell_name invert_singleValue_3
  if { [catch {set invert_singleValue_3 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $invert_singleValue_3 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net M04_ACLK_1 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins cm1_ecu_wrapper_0/TIMER_CLOCK] [get_bd_pins cm1_engine_wrapper_0/TIMER_CLOCK] [get_bd_pins cm1_throttle_wrapper_0/TIMER_CLOCK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins cm1_ecu_wrapper_0/SYS_CLOCK] [get_bd_pins cm1_engine_wrapper_0/SYS_CLOCK] [get_bd_pins cm1_throttle_wrapper_0/SYS_CLOCK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins top_0/CLK]
  ...
  connect_bd_net -net cm1_ecu_wrapper_0_DOUT [get_bd_pins cm1_ecu_wrapper_0/DOUT] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net cm1_ecu_wrapper_0_UART_TX [get_bd_pins cm1_ecu_wrapper_0/UART_TX] [get_bd_pins top_0/UART_TX_INT]
  ...
  connect_bd_net -net invert_singleValue_3_o_signal [get_bd_pins cm1_ecu_wrapper_0/RESET_INTERCONNECT] [get_bd_pins cm1_ecu_wrapper_0/RESET_PERIPHERAL] [get_bd_pins invert_singleValue_3/o_signal]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins cm1_engine_wrapper_0/RESET_INTERCONNECT] [get_bd_pins cm1_throttle_wrapper_0/RESET_INTERCONNECT] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins cm1_engine_wrapper_0/RESET_PERIPHERAL] [get_bd_pins cm1_throttle_wrapper_0/RESET_PERIPHERAL] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins top_0/RST]
  connect_bd_net -net reset_0_1 [get_bd_pins cm1_ecu_wrapper_0/RESET_TIMER] [get_bd_pins cm1_engine_wrapper_0/RESET_TIMER] [get_bd_pins cm1_throttle_wrapper_0/RESET_TIMER] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net -net top_0_REC_ECU [get_bd_pins invert_singleValue_3/i_signal] [get_bd_pins top_0/REC_ECU] [get_bd_pins xlconcat_2/In3]
  connect_bd_net -net top_0_REC_MCU [get_bd_pins top_0/REC_MCU] [get_bd_pins xlconcat_2/In5]

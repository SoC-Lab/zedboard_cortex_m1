...
set newHexFile	"/home/consti/2018WS/Lab_SoC/Abgabe/zedboard_cortex_m1/sources/Hexfiles/engine/bram_a7.hex"

# Set path to hex file that should be replaced
set oldHexFile "${projectPath}/m1_for_arty_a7.srcs/sources_1/imports/engine/bram_a7.hex"
...
#file copy -force $newHexFile $oldHexFile

...
--Command     : generate_target cm3_ecu_wrapper.bd
--Design      : cm3_ecu_wrapper
...
architecture STRUCTURE of cm3_ecu_wrapper is
  component cm3_ecu is
  port (
    DIN : in STD_LOGIC_VECTOR ( 31 downto 0 );
    DOUT : out STD_LOGIC_VECTOR ( 31 downto 0 );
    I2C_SCL : out STD_LOGIC;
  ...
  end component cm3_ecu;
begin
cm3_ecu_i: component cm3_ecu
     port map (
